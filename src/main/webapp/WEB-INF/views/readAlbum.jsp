...
<body>
	...
	<div class="container-fluid text-center">
		<form action="${pageContext.request.contextPath }/album/update"
			method="post">
				...
				<table class="table table-striped table-hover">
						...
						<tr>
							<td colspan="2">
								<div class="form-group row">
									...
									<div class="col-sm-6">
										<c:forEach items="${albumcategories }" var="category">
											<c:if test="${category.id eq album.albumCategoryId }">
												<input type="text" readonly="readonly"
													name="albumCategoryId" class="form-control" style="background-color:#FFFFFF"
													value="${category.name }">
											</c:if>
										</c:forEach>
									</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<input id="title" class="form-control" type="text" style="background-color:#FFFFFF"
											readonly="readonly" name="title" value="${album.title }">
									</div>
								</div>
							</td>
						</tr>
					...
					<tr>
						<td colspan="4"><label for="fileUpload" class="colsm-4 col-form-labe">사진</label><br>
							<img id="thumb_img" name="thumb_img" src="${pageContext.request.contextPath }/${albumFiles[0].saveFileName} ">
						...
						<tr>
							<td colspan="4"><label for="content"
								class="col-sm-1 col-form-labe">내용</label> <textarea
									class="form-control" id="content" name="content" rows="5" readonly="readonly"
									style="resize: none; background-color:#FFFFFF">${album.content }</textarea></td>
						</tr>
					</tbody>
				</table>
				<input type="text" style="display:none;" name="id" value="${album.id }">
